...
const AdminEntry = ({ entry }: IEntryParams) => {
  const { refreshPage, setRefreshPage } = useDataContext();
  ...
  return (
    <>
      ...
      >
        <div
          className={`flex flex-col justify-center p-2 w-full gap-2 rounded-md text-left bg-lightGray dark:bg-darkGray`}
        >
          <div
            className={
              'w-full h-[102vw] sm:h-[52vw] md:h-[35.33vw] lg:h-[22vw] xl:h-[18.66vw] xxl:h-[16.28vw] rounded-md border border-gray overflow-hidden'
            }
          >
            <img
          ...
          <div className='flex gap-2'>
            <button
              className='flex flex-1 justify-center py-2 bg-green text-white rounded-md hover:bg-lightGray dark:hover:bg-darkGray hover:text-green duration-200'
              onClick={() =>
            ...
            <button
              className='flex flex-1 justify-center py-2 bg-red text-white rounded-md hover:bg-lightGray dark:hover:bg-darkGray hover:text-red duration-200'
