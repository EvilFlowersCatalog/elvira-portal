...
const tocLoans = [
  ...
  'Formát a čítačka',
  'Prístupová fráza',
  'Doba výpožičky a predĺženie',
  'Vrátenie knihy',
];

const tocReservations = [
  'Ako si rezervovať knihu',
  'Ako funguje poradie čakajúcich',
  'Notifikácie a výpožička',
  'Zrušenie rezervácie',
  'Počet súbežných výpožičiek a rezervácií',
];
    ...
    <div className="h-screen overflow-auto">
      ...
      <div className="px-6 py-8 max-w-5xl mx-auto flex gap-6 items-start">
        ...
        <div className="flex-1 bg-white rounded-lg p-6 min-w-0">
          ...
          <h3 className="text-base font-semibold text-secondary mb-2">Ako si požičať knihu</h3>
          ...
          <h3 className="text-base font-semibold text-secondary mb-2">Formát a čítačka</h3>
          <p className="text-sm text-gray-600 leading-relaxed mb-5">
          ...
          <h3 className="text-base font-semibold text-secondary mb-2">Prístupová fráza</h3>
          <p className="text-sm text-gray-600 leading-relaxed mb-3">
          ...
          <h3 className="text-base font-semibold text-secondary mb-2">Doba výpožičky a predĺženie</h3>
          <p className="text-sm text-gray-600 leading-relaxed mb-3">
          ...
          <h3 className="text-base font-semibold text-secondary mb-2">Vrátenie knihy</h3>
          ...
          <h3 className="text-base font-semibold text-secondary mb-2">Ako si rezervovať knihu</h3>
          <p className="text-sm text-gray-600 leading-relaxed mb-5">
          ...
          <h3 className="text-base font-semibold text-secondary mb-2">Ako funguje poradie čakajúcich</h3>
          <p className="text-sm text-gray-600 leading-relaxed mb-3">
          ...
          <h3 className="text-base font-semibold text-secondary mb-2">Notifikácie a výpožička</h3>
          <p className="text-sm text-gray-600 leading-relaxed mb-5">
          ...
          <h3 className="text-base font-semibold text-secondary mb-2">Zrušenie rezervácie</h3>
          <p className="text-sm text-gray-600 leading-relaxed mb-5">
          ...
          <h3 className="text-base font-semibold text-secondary mb-2">Počet súbežných výpožičiek a rezervácií</h3>
