...
import { DeleteDialogComponent } from 'src/app/admin/components/dialogs/delete-dialog/delete-dialog.component';
import { MatTableDataSource } from '@angular/material/table';
import { MatPaginator } from '@angular/material/paginator';
import { AdminService } from '../../services/admin.service';
import { AllEntryItems } from '../../services/admin.types';
import { NewFeedDialogComponent } from 'src/app/admin/components/dialogs/new-feed-dialog/new-feed-dialog.component';
import { UpdateDialogComponent } from 'src/app/admin/components/dialogs/update-dialog/update-dialog.component';
